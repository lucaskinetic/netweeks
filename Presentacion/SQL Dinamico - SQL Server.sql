...
SELECT CONCAT(
	'ALTER TABLE ', table_name, ' ADD COLUMN (ID_USUARIO_APP INT UNSIGNED NOT NULL);',
	...
	'ALTER TABLE ', table_name, ' ADD COLUMN (FECHA_BAJA DATETIME);'
)
FROM SYS.schema_table_statistics where table_schema = 'netweeks'
